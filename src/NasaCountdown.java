...
public class NasaCountdown {
	public static void main(String[] args) {
		...
		String answer = JOptionPane.showInputDialog("Put in the passcode");
		
		if(answer.equals ("hot potato")){
	
		
		// 3. convert the user's answer to an int (Integer.parseInt)
			String countdown = JOptionPane.showInputDialog("How long until liftoff???");
		int porquipine = Integer.parseInt(countdown);
		// 4. countdown from user's starting point
		// 1. countdown from 10 to 0
		for(int i = porquipine; i > -1; i--){
